    ...
    <header className="bg-white">
      ...
      >
        ...
        <div className="hidden lg:flex lg:flex-1  lg:gap-5 lg:justify-end">
          ...
          <a
            href="#"
            className="text-sm font-semibold leading-6 font-lato font-semibold  rounded-md px-6 p-2 text-white bg-gradient-to-b from-[#ffe55c] to-[#FAD200]"
          >
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">NCT</span>
              <img
                className="h-8 w-auto"
                src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600"
                alt=""
